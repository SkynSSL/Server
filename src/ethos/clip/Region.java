...
public class Region {
	...
	private static final WorldObject[] EXISTANT_OBJECTS = {
			...
			//Halloween
			new WorldObject(298, 2969, 2787, 0, 0), //Bales
			new WorldObject(298, 2975, 2787, 0, 0),
	...
	private static void addObject(int objectId, int x, int y, int height, int type, int direction) {
