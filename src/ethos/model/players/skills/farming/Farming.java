...
/*              if (id >= 4 && player.amountDonated < 150) {
                ...
                if (itemId == herb.getSeedId() && player.getItems().playerHasItem(FarmingConstants.SEED_DIBBER)) {
                     ...
                     */
                    double regExperience = herb.getPlantingXp() + herb.getPlantingXp() / 20 * pieces;
                    if (player.debugMessage)
                    System.out.println("Plant xp: " + herb.getPlantingXp() * ((Config.FARMING_EXPERIENCE * player.prestige()) + (hasMagicSecateurs() ? 5 : 0)) + herb.getPlantingXp() + ", Pieces: " + pieces);
                    CycleEventHandler.getSingleton().stopEvents(this);
                    CycleEventHandler.getSingleton().addEvent(this, new CycleEvent() {
                        ...
                        public void execute(CycleEventContainer container) {
                            ...
                            player.getPA().addSkillXP((int) regExperience, 19, true);
            ...
            if(player.getFarmingState(id) == State.HARVEST.getId()) {
                ...
                if(player.debugMessage)
                    System.out.println("Harvest xp: " + herb.getHarvestingXp() * (Config.FARMING_EXPERIENCE * player.prestige()) + herb.getHarvestingXp() + ", Pieces: " + pieces);
                if(herb != null) {
                    if (player.stopPlayerSkill)
                        return true;
                    player.stopPlayerSkill = true;
                    ...
                    CycleEventHandler.getSingleton().addEvent(this, new CycleEvent() {
                        ...
                        public void execute(CycleEventContainer container) {
                            ...
                            player.prestigeNumber = 19;
                            player.currentPrestigeLevel = player.prestigeLevel[player.prestigeNumber];
 
                            if (player.currentPrestigeLevel == 1) {
                                if (Misc.random(20) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 2) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            ...
                            if (player.currentPrestigeLevel == 3) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(500));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 4) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(1000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 5) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(2000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 6) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(3000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 7) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(4000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 8) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(5000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel == 9) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(6000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                           
                            if (player.currentPrestigeLevel >= 10) {
                                if (Misc.random(15) == 0) {
                                    player.getItems().addItem(herb.getGrimyId(), 1);
                                    player.getItems().addItem(995, Misc.random(7000));
                                    player.sendMessage("@blu@You have recieved an extra herb!");
                                }
                            }
                            //if (perk)
                            ...
                            //else
                            player.getItems().addItem(herb.getGrimyId(), 1);
                            player.getPA().addSkillXP((int) regHarvestExperience, 19, true);
                            if (Misc.random(herb.getPetChance()) == 20 && player.getItems().getItemCount(20661, false) == 0 && player.summonId != 20661) {
                                 ...
                                 DiscordMessager.sendLootations("[News] " + player.playerName + " harvested some crops and found Tangleroot pet!");
    ...
    public void farmPoisonBerry() {
        ...
        player.getPA().addSkillXP(50, Skill.FARMING.getId(), true);
