...
public class Fletching {
	...
	public void fletchGem(int use, int used) {
		...
		gem.ifPresent(g -> {
			...
			player.getPA().addSkillXP((int) g.getExperience(), Skill.FLETCHING.getId(), true);
		});
	}
	...
	public void fletchUnfinishedBolt(int boltId) {
		...
		bolt.ifPresent(b -> {
			...
			player.getPA().addSkillXP((int) b.getExperience(), Skill.FLETCHING.getId(), true);
		});
	}
	...
	public void fletchHeadlessArrows() {
		...
		player.getPA().addSkillXP((int) 15, Skill.FLETCHING.getId(), true);
	}
