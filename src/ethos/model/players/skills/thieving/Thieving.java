 ...
 */
		...
		player.getPA().addSkillXP((int) regExperience, Skill.THIEVING.getId(), true);
	...
	public void steal(Pickpocket pickpocket, NPC npc) {
		...
		Achievements.increase(player, AchievementType.THIEV, 1);
		player.getPA().addSkillXP((int) pickpocket.experience, Skill.THIEVING.getId(), true);
		lastInteraction = System.currentTimeMillis();
	}

	private enum Rarity {
		ALWAYS(0), COMMON(5), UNCOMMON(10), RARE(15), VERY_RARE(25), EXTREMELY_RARE(35);
	...
	public enum Pickpocket {
		MAN(1, 2, 55000, new HashMap<Rarity, List<GameItem>>() {
		{
			put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 750), new GameItem(995, 1000)));
		}
	}), 
		FARMER(10, 4, 55000, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 800), new GameItem(995, 1000)));
				put(Rarity.RARE, Arrays.asList(new GameItem(5291, 1)));
			}
		}),
		HAM_MEMBER(20, 16, 54500, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.COMMON, Arrays.asList(new GameItem(995, 600), new GameItem(688), new GameItem(697), new GameItem(686), new GameItem(314, 15)));
				put(Rarity.UNCOMMON, Arrays.asList(new GameItem(2677), new GameItem(1511), new GameItem(1734), new GameItem(5302), new GameItem(1739), new GameItem(946), new GameItem(453), new GameItem(1625)));
				put(Rarity.RARE, Arrays.asList(new GameItem(4298), new GameItem(4300), new GameItem(4302), new GameItem(4304), new GameItem(4306), new GameItem(4308), new GameItem(4310)));
			}
		}),
		WARRIOR(25, 18, 55000, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 1500)));
			}
		}),
		ROGUE(32, 20, 55000, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 4000)));
				put(Rarity.COMMON, Arrays.asList(new GameItem(1994, 1), new GameItem(556, 8)));
				put(Rarity.RARE, Arrays.asList(new GameItem(1219), new GameItem(1524)));
			}
		}),
		MASTER_FARMER(38, 24, 52000, new HashMap<Rarity, List<GameItem>>() {
			{
		...
		GUARD(40, 25, 52500, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 2000)));
			}
		}),
		ARDOUGNE_KNIGHT(55, 70, 52000, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 2300)));
			}
		}),
		 MENAPHITE_THUG(65, 75, 50000, new HashMap<Rarity, List<GameItem>>() {
		{
			put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 2800)));
		} 
	}), 
		PALADIN(70, 87, 48000, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(562, 5), new GameItem(995, 3100)));
			} 
		}), 
		GNOME(75, 97, 45000, new HashMap<Rarity, List<GameItem>>() {
		{
			put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 3500)));
			put(Rarity.COMMON, Arrays.asList(new GameItem(444), new GameItem(557), new GameItem(13431, 5)));
			put(Rarity.UNCOMMON, Arrays.asList(new GameItem(569)));
		}
	}), HERO(80, 128, 38000, new HashMap<Rarity, List<GameItem>>() {
		{
			put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 3800)));
			put(Rarity.UNCOMMON, Arrays.asList(new GameItem(560, 2), new GameItem(565), new GameItem(444), new GameItem(1601), new GameItem(569)));
		}
	}),
		ELF(85, 500, 30000, new HashMap<Rarity, List<GameItem>>() {
			{
				put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, 20000)));
				put(Rarity.UNCOMMON, Arrays.asList(new GameItem(560, 2), new GameItem(561, 3), new GameItem(444), new GameItem(1601), new GameItem(569)));
				put(Rarity.VERY_RARE, Arrays.asList(new GameItem(995, 38000)));
				put(Rarity.EXTREMELY_RARE, Arrays.asList(new GameItem(4212), new GameItem(4224)));
			}
	});
	...
	public enum Stall {
		Crafting(new GameItem(995, Misc.random(250) + 5000), 1, 16, 20, 45000),
		Food(new GameItem(995, Misc.random(750) + 7000), 25, 30, 10, 42500), 
		General(new GameItem(995, Misc.random(1000) + 8000), 50, 54, 10, 40000), 
		Magic(new GameItem(995, Misc.random(1250) + 9000), 75, 80, 10, 38000), 
		Scimitar(new GameItem(995, Misc.random(1500) + 10000), 90, 100, 10, 36500),
		Fur(new GameItem(995, Misc.random(2000) + 10500), 50, 54, 10, 40000);
