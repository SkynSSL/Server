...
public enum Tree {
	...
	OAK(new int[] { 1751, 11756, 10820 }, 1356, 1521, 15, 8, 50, 38, 25, 11500), 
	WILLOW(new int[] { 1756, 1760, 1750, 1758, 11759, 11761, 11763, 11755, 10819, 10833 }, 1356, 1519, 30, 10, 60, 68, 35, 11000), 
	TEAK(new int[] { 9036 }, 1356, 6333, 35, 10, 65, 68, 35, 10500), 
	MAPLE(new int[] { 1759, 11762, 10832 }, 1356, 1517, 45, 13, 75, 100, 45, 10000), 
	ARCTIC_PINE(new int[] { 3037 }, 1356, 10810, 54, 14, 85, 100, 50, 90400),
	YEW(new int[] { 1753, 1754, 11758, 27255, 10822 }, 1356, 1515, 60, 15, 100, 175, 60, 9000), 
	MAGIC(new int[] { 1761, 11764, 10834 }, 9713, 1513, 75, 20, 125, 250, 75, 8600), 
