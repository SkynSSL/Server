...
public class RooftopSeers {
	...
	public static final int WALL = 14927, JUMP_GAP = 25927, TIGHT_ROPE = 14932, JUMP_2ND_GAP = 14929, JUMP_3RD_GAP = 14930, JUMP_EDGE = 14931, LADDER = 26119;
	...
	public boolean execute(final Player c, final int objectId) {
			...
			CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
				...
				public void execute(CycleEventContainer container) {
					...
					case 2:
						...
						AgilityHandler.delayEmote(c, "HANG_ON_POST", 2739, 3504, 0, 1);
						c.getAgilityHandler().agilityProgress[0] = true;
						container.stop();
						c.sendMessage("You got high and ended up in a library, search the bookcase.");
						break;
					}
				}
		...
		case TIGHT_ROPE:
			...
			return true;
		case LADDER:
			c.sendMessage("Wrong obstacle, click jump gap.");
			return true; 
		case JUMP_2ND_GAP:
