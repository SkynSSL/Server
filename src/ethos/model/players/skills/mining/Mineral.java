...
public enum Mineral {
	...
	//objectIds, String barName, int level, double experience, int depletionProbability, int respawnRate, int extractionRate, int petChance, boolean depletes, MineralReturn mineralReturn)
			...
			ADAMANT(new int[] { 7493, 13720, 7460, 11375 }, "adamant", 70, 95, 2, 50, 37, 13200, true, generateExclusive(449)),
			...
			MITHRIL(new int[] { 7492, 13718, 7459, 11372, 11373 }, "mithril", 55, 80, 3, 40, 35, 13800, true, generateExclusive(447)),  
			RUNE(new int[] { 7494, 7461, 14175, 11377 }, "rune", 85, 125, 0, 100, 39, 12500, true, generateExclusive(451)), 
			...
			FAIRY(new int[] { 28496, 28497 }, "none", 90, 25, 0, -1, Misc.random(10), 15000, false, generateExclusive(13571)),	
