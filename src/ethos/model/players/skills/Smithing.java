...
public class Smithing {
	...
	private boolean canSmelt(final int barType) {
	...
	private static void doAction(final Player c, final int toadd, final int toremove, final int toremove2, final int timestomake, final int NOTUSED, final int NOTUSED2,
								 final double xp) {
		c.event = 3;
							...
							if (ItemAssistant.getItemName(toadd).contains("dart")) {
								...
								if (ItemAssistant.getItemName(toadd).contains("knife")) {
									...
									if (ItemAssistant.getItemName(toadd).contains("cannon")) {
										...
										c.prestigeNumber = 21;
										c.currentPrestigeLevel = c.prestigeLevel[c.prestigeNumber];
										
										if (c.currentPrestigeLevel == 1) {
											if (Misc.random(15) == 0) {
												c.getItems().addItem(toadd, 1);
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel == 2) {
											if (Misc.random(14) == 0) {
												c.getItems().addItem(toadd, 1);
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										...
										if (c.currentPrestigeLevel == 3) {
											if (Misc.random(14) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(500));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel == 4) {
											if (Misc.random(13) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(1000));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel == 5) {
											if (Misc.random(13) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(2000));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel == 6) {
											if (Misc.random(12) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(3000));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel == 7) {
											if (Misc.random(12) == 0) {
												c.getItems().addItem(toadd, 1);
										...
										if (c.currentPrestigeLevel == 8) {
											if (Misc.random(11) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(5000));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel == 9) {
											if (Misc.random(11) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(6000));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
										
										if (c.currentPrestigeLevel >= 10) {
											if (Misc.random(10) == 0) {
												c.getItems().addItem(toadd, 1);
												c.getItems().addItem(995, Misc.random(7000));
												c.sendMessage("@blu@You smithed an extra piece!");
											}
										}
									}
	...
	private int getExp(final int barType) {
		for (int j = 0; j < SMELT_BARS.length; j++) {
			if (barType == SMELT_BARS[j]) {
				return SMELT_EXP[j];
			}
	...
	private int getOre(final int barType) {
		for (int j = 0; j < SMELT_BARS.length; j++) {
			if (barType == SMELT_BARS[j]) {
	...
	private int getOre2(final int barType) {
		for (int j = 0; j < SMELT_BARS.length; j++) {
			if (barType == SMELT_BARS[j]) {
	...
	private boolean hasOres(final int barType) {
	...
	private void smelt(final int barType) {
		...
		if (c.smeltAmount > 0) {
			...
			if (hasOres(barType)) {
				...
				c.getPA().addSkillXP((int) exp, Player.playerSmithing, true);
