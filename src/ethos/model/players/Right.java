...
public enum Right implements Comparator<Right> {
	...
	GMODERATOR(24, "C15B01", MODERATOR),
	FMODERATOR(25, "C15B01", MODERATOR),

    //admins
    ADMINISTRATOR(2, "F5FF0F", MODERATOR), 
	OWNER(3, "F5FF0F", ADMINISTRATOR), 

    GAME_DEVELOPER(16, "544FBB"), // seems to inheriant from OWNER is most cases
	...
	public boolean isModerator() {
		return isModerator() || isFModerator();
	}
	...
	public boolean isStaff() {
		return isHelper() || isModerator() || isAdministrator() || isOwner() || isFModerator();
	}
	...
	public static final Right[] PRIORITY = { PLAYER, OSRS, IRONMAN, ULTIMATE_IRONMAN, CONTRIBUTOR, SPONSOR, SUPPORTER, DONATOR, SUPER_DONATOR, EXTREME_DONATOR, LEGENDARY, RESPECTED_MEMBER, HITBOX, YOUTUBER, HELPER, GAME_DEVELOPER, MODERATOR, ADMINISTRATOR, OWNER, UNKNOWN, };
