...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 8772:
			...
			break;
					case 8765:
			sendNpcChat4("Hello I can make overload potions for you.", "The most you can make at one time is 4.", "You need 1 of each of these ingredients...", "Super strength, Super defence, Super attack, Magic potion", c.talkingNpc, "Bob");
			c.nextChat = 8766;
			break;
		case 8766:
			sendNpcChat3("Ranging potion.", "You also need 90 Herblore to do this.", "Do you want me to make you over loads?", c.talkingNpc, "Bob");
			c.nextChat = 8767;
			break;
		case 8767:
			sendOption2("Yes", "No");
			c.dialogueAction = 8767;
			break;
		...
		case 8768:
			...
			break;
				case 9223: // sapphire
			sendOption4("Amulet", "Bracelet", "Necklace", "Ring");
			c.dialogueAction = dialogue;
			break;
		case 9224: // Emerald
			sendOption4("Amulet", "Bracelet", "Necklace", "Ring");
		...
		case 15002:
			sendNpcChat2("It seems you already have a house", "Speak with me to remove your house", 5419, "Estate Agent");
			c.nextChat = 15001;
			break;
			
		case 15003:
			sendPlayerChat1("I'm looking to buy a house do you have any for sale?");
			c.nextChat = 15004;
			break;
			
		case 15004:
			sendNpcChat2("Each house costs 10 million coins", "Are you sure you want to continue?", 5419, "Estate Agent");
			c.nextChat = 15005;
			break;
			
		case 15005:
			sendOption2("Yes", "Nevermind");
			c.dialogueAction = 15005;
			break;
			
		case 15006:
			sendNpcChat1("Thank you for your purchase.", 5419, "Estate Agent");
			c.nextChat = -1;
			break;
			
		case 15007:
			sendPlayerChat1("Can I be teleported to my house?");
			c.nextChat = 15008;
			break;
		
		case 15008:
			sendNpcChat1("Sure thing", 5419, "Estate Agent");
			c.isInHouse = true;
			c.getPA().movePlayer(2457, 2583, c.getIndex() * 4);
			c.nextChat = -1;
			break;
			
		case 16000:
			sendOption5("Build Mode", "Remove House", "Reload House", "Settings", "Nevermind");
			c.dialogueAction = 16000;
			break;
			
		case 16050:
			sendOption3("Rooms", "Objects", "@red@Back");
			c.dialogueAction = 16050;
			break;
			
		case 16051:
			sendOption4("Small Room", "Medium Room", "Large Room", "@red@Back");
			c.dialogueAction = 16051;
			break;
			
		case 16052:
			sendOption5("Crates", "Barrels", "Signs", "Chairs", "@red@Next Page");
			c.dialogueAction = 16052;
			break;
			
		case 16053:
			sendOption2("Wooden Crate", "Test Crate");
			c.dialogueAction = 16053;
			break;
			
		case 16054:
			sendOption5("North", "East" , "South", "West", "Build");
			c.dialogueAction = 16054;
			break;
		
		case 6500:
			sendOption4("Unobtainable Shop", "Special Shop", "Toys Shop", "Nevermind");
			c.dialogueAction = 6500;
			break;
		...
		case 9001:
			sendNpcChat3("Well, the last time I was above ground", "I was having to contend with people throwing snow", "at some weird yellow duck in my park.", 6651, "Baby Mole");
			c.nextChat = 9002;
			break;
		...
		case 9003:
			sendNpcChat2("No idea, I didn't stop to ask as an angry mob", "was closing in on them pretty quickly.", 6651, "Baby Mole");
			c.nextChat = 9004;
			break;
		...
		case 9005:
			sendNpcChat1("Anyway, keep Molin'!", 6651, "Baby Mole");
			c.nextChat = -1;
			break;
		...
		case 9007:
			sendNpcChat1("You're not funny...", 5558, "Callisto Cub");
			c.nextChat = 9008;
			break;
		...
		case 9010:
			sendNpcChat1("You're really not funny...", 5558, "Callisto Cub");
			c.nextChat = 9011;
			break;
		...
		case 9012:
			sendNpcChat1(".....", 5558, "Callisto Cub");
			c.nextChat = 9013;
			break;
		...
		case 9014:
			sendNpcChat2("If you don't stop, I'm going to leave some...", " brown... at your feet, human.", 5558, "Callisto Cub");
			c.nextChat = -1;
			break;
			
		case 9015:
			sendPlayerChat1("How many souls have you devoured?");
			c.nextChat = 9016;
			break;
			
		case 9016:
			sendNpcChat1("None.", 3099, "Hellpuppy");
			c.nextChat = 9017;
			break;
			
		case 9017:
			sendPlayerChat1("Awww p-");
			c.nextChat = 9018;
			break;
			
		case 9018:
			sendNpcChat1("Yet.", 3099, "Hellpuppy");
			c.nextChat = 9019;
			break;
		...
		case 9020:
			sendPlayerChat1("Why were the hot dogs shivering?");
			c.nextChat = 9021;
			break;
			
		case 9021:
			sendNpcChat1("Grrrrr...", 3099, "Hellpuppy");
			c.nextChat = 9022;
			break;
			
		case 9022:
			sendPlayerChat1("Because they were served-");
			c.nextChat = 9023;
			break;
	
		case 9023:
			sendNpcChat1("GRRRRRR...", 3099, "Hellpuppy");
			c.nextChat = 9024;
			break;
			
		case 9024:
			sendPlayerChat1("-with... chilli?");
			c.nextChat = 1;
			break;
			
		case 9025:
			sendPlayerChat1("Hell yeah! Such a cute puppy!");
			c.nextChat = 9026;
			break;
			
		case 9026:
			sendNpcChat1("Silence mortal! Or I'll eat your soul.", 3099, "Hellpuppy");
			c.nextChat = 9027;
			break;
			
		case 9027:
			sendPlayerChat1("Would that go well with lemon?");
			c.nextChat = 9028;
			break;
			
		case 9028:
			sendNpcChat1("Grrr...", 3099, "Hellpuppy");
			c.nextChat = -1;
			break;
			
		case 9029:
			sendPlayerChat1("What a cute puppy, how nice to meet you.");
			c.nextChat = 9030;
			break;
			
		case 9030:
			sendNpcChat1("It'd be nice to meat you too...", 3099, "Hellpuppy");
			c.nextChat = 9031;
			break;
			
		case 9031:
			sendPlayerChat1("Urk... nice doggy.");
			c.nextChat = 9032;
			break;
		...
		case 9033:
			sendPlayerChat2("I wonder if I need to invest in a trowel", "when I take you out for a walk.");
			c.nextChat = 9034;
			break;
			
		case 9034:
			sendNpcChat1("More like a shovel.", 3099, "Hellpuppy");
			c.nextChat = -1;
			break;
		...
		case 9036:
			sendNpcChat1("Truthfully?", 6637, "Kalphite Princess");
			c.nextChat = 9037;
			break;
		...
		case 9038:
			sendNpcChat1("Soup. We make a fine soup with it.", 6637, "Kalphite Princess");
			c.nextChat = 9039;
			break;
		...
		case 9040:
			sendNpcChat3("Nah, we just collect it and put it there because", "we know fools like yourself will come down", "looking for it then inevitably be killed by my mother.", 6637, "Kalphite Princess");
			c.nextChat = 9041;
			break;
		...
		case 9042:
			sendNpcChat1("Touche", 6637, "Kalphite Princess");
			c.nextChat = -1;
			break;
		...
		case 9043:
			sendNpcChat1("Truthfully?", 6638, "Kalphite Princess");
			c.nextChat = 9044;
			break;
		...
		case 9045:
			sendNpcChat1("Soup. We make a fine soup with it.", 6638, "Kalphite Princess");
			c.nextChat = 9046;
			break;
		...
		case 9049:
			sendNpcChat1("Touche", 6638, "Kalphite Princess");
			c.nextChat = -1;
			break;
			
		case 9051:
			sendPlayerChat2("Is it true a level 3 skiller", "caught one of your siblings?");
			c.nextChat = 9052;
			break;
			
		case 9052:
			sendNpcChat2("Yes, they killed my mummy, kidnapped my brother", "smiled about it and went to sleep.", 5907, "Chaos Elemental Jr.");
			c.nextChat = 9053;
			break;
		...
		case 9054:
			sendNpcChat2("Come on, Squishy come on", "little Squishy!", 5907, "Chaos Elemental Jr.");
			c.nextChat = -1;
			break;
		...
		case 9056:
			sendNpcChat1("Definitely.", 6627, "Dagannoth Prime Jr.");
			c.nextChat = 9057;
			break;
		...
		case 9058:
			sendNpcChat1("Ugh. Human, I'm not a pet.", 6627, "Dagannoth Prime Jr.");
			c.nextChat = 9059;
			break;
		...
		case 9060:
			sendNpcChat1("I can't seem to stop.", 6627, "Dagannoth Prime Jr.");
			c.nextChat = 9061;
			break;
		...
		case 7600:
			c.chosenCow = false;
			c.chosenChicken = false;
			c.chosenGoblin = false;
			c.chosenCaveBug = false;
			c.chosenMan = false;
			c.chosenWoman = false;
			c.chosenFarmer = false;
			c.chosenThug = false;
			c.chosenBanshee = false;
			c.chosenCrawlingHand = false;
			c.chosenDesertLizard = false;
			c.chosenKalphiteWorker = false;
			c.chosenSkeleton = false;
			c.chosenSandCrab = false;
			c.chosenChaosDruid = false;
			c.chosenGhost = false;
			sendOption5("Level-1", "Level-2", "Level-3", "Level-4", "Next Page");
			c.dialogueAction = 7600;
			break;
			
		case 7700:
			sendOption5("Level-5", "Level-6", "Level-7", "Level-8", "Next Page");
			c.dialogueAction = 7700;
			break;
			
		case 7800:
			sendOption3("Level-9", "Level-10", "Nevermind");
			c.dialogueAction = 7800;
			break;
			
		case 7601: //Level 1
			sendOption5("Cow", "Chicken", "Goblin", "Cave Bug", "Next Page");
			c.dialogueAction = 7601;
			break;
			
		case 7602: //Level 1
			sendOption5("Man", "Woman", "Farmer", "Thug", "Nevermind");
			c.dialogueAction = 7602;
			break;
			
		case 7603: //Level 2
			sendOption5("Crawling Hand", "Desert Lizard", "Banshee", "Kalphite Worker", "Next Page");
			c.dialogueAction = 7603;
			break;
			
		case 7604: //Level 2
			sendOption5("Skeleton", "Chaos Druid", "Ghost", "Sand Crab", "Nevermind");
			c.dialogueAction = 7604;
			break;
			
		case 7605: //Level 3
			sendOption5("Rockslug (422)", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7605;
			break;
			
		case 7606: //Level 3
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7606;
			break;
			
		case 7607: //Level 4
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7607;
			break;
			
		case 7608: //Level 4
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7608;
			break;
			
		case 7609: //Level 5
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7609;
			break;
			
		case 7610: //Level 5
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7610;
			break;
			
		case 7611: //Level 6
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7611;
			break;
			
		case 7612: //Level 6
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7612;
			break;
			
		case 7613: //Level 7
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7613;
			break;
			
		case 7614: //Level 7
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7614;
			break;
			
		case 7615: //Level 8
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7615;
			break;
			
		case 7616: //Level 8
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7616;
			break;
			
		case 7617: //Level 9
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7617;
			break;
			
		case 7618: //Level 9
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7618;
			break;
			
		case 7619: //Level 10
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Next Page");
			c.dialogueAction = 7619;
			break;
			
		case 7620: //Level 10
			sendOption5("Placeholder", "Placeholder", "Placeholder", "Placeholder", "Nevermind");
			c.dialogueAction = 7620;
			break;
		
		case 7500:
			sendPlayerChat1("Please choose a difficulty");
			c.nextChat = 7501;
			break;
		
		case 7501:
			sendOption5("Easy", "Normal", "Hard", "Explain Difficulties", "Nevermind");
			c.dialogueAction = 7501;
			break;
			
		case 7502:
			sendPlayerChat3("Each Difficulty Increases Health", "And Defence Bonus's On All Raid Monsters", "This Means More Raid Points Per Raid");
			c.nextChat = 7501;
			break;

		case 857:	//Unique DialogueHandler ID
			sendNpcChat("Please Choose A Category"); //Sending A Dialogue Thats A NPC Talking
			c.nextChat = 858; //Next Chat/Dialogue That Will Appear When You "Click Here To Continue" In This Case Its 
			break; 
			
		case 858:	//Unique DialogueHandler ID
			sendOption5("Me", "Server", "Points",
					"WOGW", "@cya@Next Page"); //Sending 5 Options A Player Can Choose From
			c.dialogueAction = 858; //Unique DialogueAction ID Thats Refferred To In FiveOptions.java
			break; 
			
		case 860:
			sendNpcChat("Wtf you want noob lol?");
			c.nextChat = 861;
			break;
			
		case 861:
			sendOption5("@red@Teleport Home", "@gre@Give Max Cash", "@red@God-Mode",
					"@red@Max", "@cya@Next Page");
			c.dialogueAction = 861;
			break;
		...
		case 863:
			sendOption5("@red@Fly", "@gre@Reset Stats", "@red@Bank",
					"@red@Empty", "@cya@Next Page");
			c.dialogueAction = 863;
			break;
		/*
		 * Raids historian
		 */
		...
		case 193193:
			sendOption5("Piscarlarious House", "Hosidius House", "Shayzien House", "Mount Quidamortem", "Arecuus @red@Danger");
		...
		case 701:
			...
			if (c.getItems().playerHasItem(13273)) {
				...
				DiscordMessager.sendLootations("[PET] "
						+ c.playerName + " received a pet from Abyssal Sire.");
				}
				switch (reward) {
				case 13274:
				...
				//PlayerHandler.executeGlobalMessage("<img=9>[@red@Lootz@bla@] @blu@" + Misc.capitalize(c.playerName) + " @bla@received  @blu@1@bla@x @blu@"
						//+ ItemAssistant.getItemName(reward) + "@bla@.");
				 PlayerHandler.executeGlobalMessage("[@red@Lootations@bla@]@blu@ @cr9@ <col=255><img="+rights+">" + Misc.formatPlayerName(c.playerName) + "</col> received @blu@1@bla@x @blu@" + ItemAssistant.getItemName(reward) + ".");
				 DiscordMessager.sendLootations("[Lootations] " + Misc.formatPlayerName(c.playerName) + " received 1x " + ItemAssistant.getItemName(reward) + ".");
		...
		case 11929:
			sendNpcChat3("Hello " + c.playerName + " I am the OSRS GP Donation Manager.",
					"If you are interested in donating, contact Pepsiplaya.",
					"Donate to anyone else you will be perm banned!", 3189, "GP Donation Manager");
			c.nextChat = 11930;
			break;

		case 11930:
			sendNpcChat2("The current exchange rates are:", "@red@OSRS Gold: @blu@1m = $0.70", 3189,
					"GP Donation Manager");
			c.nextChat = -1;
			break;
		...
		case 63:
			sendOption5("Resource Area @bla@(@red@Wilderness@bla@)", "KBD Lair",
					"Godwars Dungeon + 10 KC", "Corporeal Beast Lair", "");
			c.dialogueAction = 61;
			break;
		...
		case 81:
			sendItemStatement("The Elite Void Knight upgrades your armor.", 13072);
			c.nextChat = -1;
			break;
		case 82:
			sendItemStatement("The Elite Void Knight upgrades your armor.", 13073);
			c.nextChat = -1;
			break;

		case 1427:
			sendNpcChat3("I am Ak-Haranu and I'm in charge of Prestiging.",
					"Prestiging lets players set the skill back to", "level one in order to gain multiple perks.", 2989, "Ak-Haranu");
			c.nextChat = 1428;
			break;
		case 1428:// Prestige
			sendOption3("Open Prestige Manager", "See Prestige Perks", "Cancel");
		...
		case 55864:
			sendNpcChat2("Welcome and enjoy "+Config.SERVER_NAME+"!", "Feel free to ask for help in the Help cc.",
		...
		case 55865:
			...
			break;
		case 55866:
			sendNpcChat2("Welcome and enjoy "+Config.SERVER_NAME+"!", "Feel free to ask for help in the Help cc.", c.talkingNpc,
					"Shayzien Guard");
			c.nextChat = 0;
			break;
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.",
					"Interested in becoming an "+Config.SERVER_NAME+" <img=4>@red@Donator@bla@?",
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by "+Config.SERVER_NAME+" to be a travelling banker!", c.talkingNpc,
					"Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 14012:
			sendPlayerChat3("Yeah! I've never seen one before.", "I guess it's one small step for NPC's,",
					"one giant leap for "+Config.SERVER_NAME+"!");
			c.nextChat = 14013;
			break;
		case 14013:
		...
		case 505:
			...
			case 0:
				sendNpcChat2("What do you want mortal?", "Do you seek death?", c.talkingNpc, "Demon Butler");
				c.nextChat = 506;
				break;
		...
		case 507:
			sendNpcChat1("Speak up human before I lose my patience.", c.talkingNpc, "Demon Butler");
			c.nextChat = 508;
			break;

		case 508:
			sendPlayerChat2("Okay okay, what are you doing here in Mystics home land?", "You weren't here a few days ago.");
			c.nextChat = 509;
			break;

		case 509:
			sendNpcChat1("No...I wasn't. I'm seeking a few lost posessions.", c.talkingNpc, "Demon Butler");
			c.nextChat = 510;
			break;
		...
		case 511:
			sendNpcChat3("I lost a large amount of @or2@pumpkins@bla@.",
					...
					"It's probably that gang of ghosts again.", c.talkingNpc, "Demon Butler");
			c.nextChat = 512;
			break;
		...
		case 514:
			sendNpcChat4("Every Halloween I travel through the wilderness",
					...
					"by 12:00, otherwise there will be no halloween.", c.talkingNpc, "Demon Butler");
			c.nextChat = 518;
			break;
		...
		case 516:
			sendNpcChat1("Do I smell fear on you human?.", c.talkingNpc, "Demon Butler");
			c.nextChat = 517;
			break;
		...
		case 519:
			sendNpcChat3("You fool, these are no ordinary pumpkins.",
					...
					"venture to this world. Thus, no more halloween.", c.talkingNpc, "Demon Butler");
			c.nextChat = 520;
			break;

		case 520:
			sendPlayerChat3("No more halloween, that would be no more candy.",
					"That would also mean no more Demon Butler.",
		...
		case 524:
			sendNpcChat3("You will need to recover @red@50@bla@ pumpkins..",
					...
					"The chest is guarded by four ghosts.", c.talkingNpc, "Demon Butler");
			c.nextChat = 525;
			break;
		...
		case 525:
			...
			sendNpcChat4("Although they are not tough, they move quickly.",
					...
					"Here, take this locating crystal to find them.", c.talkingNpc, "Demon Butler");
			c.nextChat = 526;
			break;
		...
		case 526:
			...
			if (c.getItems().freeSlots() < 1) {
				sendNpcChat1("You need an open space for this locator.", c.talkingNpc, "Demon Butler");
				c.nextChat = -1;
				return;
			}
		...
		case 527:
			...
			sendNpcChat3("Activating this crystal will let you know", "how far you are from the chest and in which",
					"direction it lies in. Move along, be quick.", c.talkingNpc, "Demon Butler");
			c.nextChat = -1;
			break;
			...
			if (!c.getItems().playerHasItem(611) && !c.getItems().bankContains(611)) {
				if (c.getItems().freeSlots() < 1) {
					sendNpcChat2("You lost the locator, but need an open space in your",
							"inventory, come back when you have an open space.", c.talkingNpc, "Demon Butler");
					c.nextChat = -1;
					return;
				}
				sendNpcChat3("You are fortunate, I found the crystal.",
						"Do not lose this crystal again, it's important.",
						"Come talk to me when you have made some progress.", c.talkingNpc, "Demon Butler");
				c.getItems().addItem(611, 1);
				c.nextChat = -1;
			} else {
				sendNpcChat2("You must bring me back the pumpkins noted.",
						"Lets see how much progress you have made...", c.talkingNpc, "Demon Butler");
				c.nextChat = 529;
			}
			break;
		...
		case 533:
			sendNpcChat3("You came through for me human, halloween will", "continue to exist because of you.",
					"I hope you enjoy the reward I gave you.", c.talkingNpc, "Demon Butler");
			c.nextChat = 534;
			break;

		case 534:
			sendNpcChat1("Is there anything else I can do for you?", c.talkingNpc, "Demon Butler");
			c.nextChat = 535;
			break;
		...
		case 536:
			if (c.getHolidayStages().getStage("Halloween") >= 6) {
				sendNpcChat3("There is nothing left to do, you already found", "the hood I was keeping from you.",
						"Enjoy your holiday " + c.playerName + ".", c.talkingNpc, "Demon Butler");
				c.nextChat = -1;
			} else {
		...
		case 537:
			if (c.getItems().bankContains(611)) {
				sendNpcChat3("Hmm...It seems your bank has the locator in it.",
						...
						"I will provide you with one if you don't have one.", c.talkingNpc, "Demon Butler");
				c.nextChat = -1;
				return;
			}
		...
		case 581:
			sendPlayerChat3("Merry christmas to you too santa.", "If you don't mind me asking santa, what are",
					"you doing here in Mystic's home land?");
			c.nextChat = 582;
			break;
		...
		case 590:
			sendNpcChat("Normally we travel in our sleigh.", "However due to us @blu@crashing",
					"caused by the mass amount of players stomping here", "we can no longer travel with it.");
			c.nextChat = 591;
			break;
		...
		case 607:
			sendNpcChat("The toy has finished being developed.", "Talk to santa at home.");
			c.dialogueAction = -1;
			c.nextChat = -1;
			break;
		...
		case 621:
			sendNpcChat("You can repair a damaged item by using it on me.",
					"Each item has a repair cost. Repairs range from", "250,000k to 10m");
			c.nextChat = 622;
			break;
		...
		case 1000:
			sendOption2("Open the damn box", "What's inside?");
		...
		case 750:
			sendStatement("Would you like to enter the home training area for 500,000?");
			c.nextChat = 751;
			break;
		case 751:
			sendOptions("Yes", "No");
		...
		case 651:
			sendOptions("What restrictions do I have?", "I would like to revert my account",
					"I am missing armor, do you have any?", "", "Close");
		...
		case 5000:
			sendNpcChat("Hello friend, i'm here to gamble", "various different jars for pets!");
			c.nextChat = 5001;
			break;
		
		case 5001:
			sendOption3("Check for pet rates", "Roll for pet", "Nevermind");
		...
		case 661:
			...
			if (items.isEmpty()) {
				sendNpcChat("You already have all of the pieces to your set of armor.");
				c.nextChat = -1;
				return;
			}
			...
			if (c.getItems().freeSlots() < items.size()) {
				sendNpcChat("To return the equipment you must have equal",
						"free slots to the amount of armor pieces missing.", "You do not have enough space.");
				c.nextChat = -1;
				return;
			}
			...
			if (items.size() < 3) {
				sendNpcChat("You have been given back a fraction of the",
						"entire set of armor. The rest of the armor is", "on your person.");
			} else {
				sendNpcChat("You have been given back the entire set of", "armor. Good luck on your journey.");
			}
			c.nextChat = -1;
			break;
		...
		case 679:
			...
			sendNpcChat("Finally you can start your adventure,", "type ::discord to recieve alerts when events happen.",
					"Also ::forums to keep up-to-date with "+Config.SERVER_NAME+", Enjoy!.");
			c.nextChat = 645;
			break;
		...
		case 715:
			sendNpcChat("If you have been lucky enough to get your hands on",
					...
					"them into points by using the Exchange Handler right", "inside the bank at home!");
			c.nextChat = 710;
			break;
		case 1577:
