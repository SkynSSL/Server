...
public class PlayerSave {
	...
	public static int loadGame(Player p, String playerName, String playerPass) {
		...
		boolean File1 = false;
		try {
			characterfile = new BufferedReader(new FileReader(Config.CHARACTER_SAVE_DIRECTORY + p.playerName + ".txt"));
			File1 = true;
			...
			if (spot > -1) {
				...
				case 2:
					if (token.equals("character-height")) {
						...
						Player.maRound = (Integer.parseInt(token2));
					...
					} else if (token.equals("hasHouse")) {
						p.hasHouse = Boolean.parseBoolean(token2);
					} else if (token.equals("isInHouse")) {
						p.isInHouse = Boolean.parseBoolean(token2);
					...
					} else if (token.equals("bank-charges")) {
						p.bankCharges = Integer.parseInt(token2);
					} else if (token.equals("augury")) {
						p.augury = Integer.parseInt(token2);
					} else if (token.equals("rigour")) {
						p.rigour = Integer.parseInt(token2);
					...
					} else if (token.equals("LogTimer")) {
						p.LogTimer = Integer.parseInt(token2);
					} else if (token.equals("LogAmount")) {
						p.LogAmount = Integer.parseInt(token2);
					} else if (token.equals("hasTree")) {
						p.hasTree = Integer.parseInt(token2);
					} else if (token.equals("raked")) {
						p.raked = Integer.parseInt(token2);
					}else if (token.equals("compost")) {
						p.compost = Integer.parseInt(token2);
					} else if (token.equals("RockCrabs")) {
						p.RockCrabs = Integer.parseInt(token2);
					} else if (token.equals("Cows")) {
						p.Cows = Integer.parseInt(token2);
					} else if (token.equals("recentKill")) {
						p.recentKill = Integer.parseInt(token2);
					} else if (token.equals("Yaks")) {
						p.Yaks = Integer.parseInt(token2);
					} else if (token.equals("Bandits")) {
						p.Bandits = Integer.parseInt(token2);
					} else if (token.equals("Elfs")) {
						p.Elfs = Integer.parseInt(token2);
					} else if (token.equals("Dags")) {
						p.Dags = Integer.parseInt(token2);
					} else if (token.equals("Dragons")) {
						p.Dragons = Integer.parseInt(token2);
					} else if (token.equals("Gorillas")) {
						p.Gorillas = Integer.parseInt(token2);
					} else if (token.equals("SmokeDevils")) {
						p.SmokeDevils = Integer.parseInt(token2);
					} else if (token.equals("BarrelChest")) {
						p.BarrelChest = Integer.parseInt(token2);
					} else if (token.equals("KBD")) {
						p.KBD = Integer.parseInt(token2);
					} else if (token.equals("Mole")) {
						p.Mole = Integer.parseInt(token2);
					} else if (token.equals("KQ")) {
						p.KQ = Integer.parseInt(token2);
					} else if (token.equals("GWD")) {
						p.GWD = Integer.parseInt(token2);
					} else if (token.equals("Corp")) {
						p.Corp = Integer.parseInt(token2);
					} else if (token.equals("Kraken")) {
						p.Kraken = Integer.parseInt(token2);
					} else if (token.equals("Zul")) {
						p.Zul = Integer.parseInt(token2);
					} else if (token.equals("Cer")) {
						p.Cer = Integer.parseInt(token2);
					} else if (token.equals("TSD")) {
						p.TSD = Integer.parseInt(token2);
					} else if (token.equals("AbyssalSire")) {
						p.AbyssalSire = Integer.parseInt(token2);
					} else if (token.equals("LM")) {
						p.LM = Integer.parseInt(token2);
					} else if (token.equals("Vork")) {
						p.Vork = Integer.parseInt(token2);
					} else if (token.equals("Rats")) {
						p.Rats = Integer.parseInt(token2);
					} else if (token.equals("HobGoblin")) {
						p.HobGoblin = Integer.parseInt(token2);
					} else if (token.equals("Giants")) {
						p.Giants = Integer.parseInt(token2);
					} else if (token.equals("Demons")) {
						p.Demons = Integer.parseInt(token2);
					} else if (token.equals("Skeletons")) {
						p.Skeletons = Integer.parseInt(token2);
					} else if (token.equals("Ghosts")) {
						p.Ghosts = Integer.parseInt(token2);
					} else if (token.equals("Bats")) {
						p.Bats = Integer.parseInt(token2);
					} else if (token.equals("Dwarfs")) {
						p.Dwarfs = Integer.parseInt(token2);
					} else if (token.equals("Druids")) {
						p.Druids = Integer.parseInt(token2);
					} else if (token.equals("Knights")) {
						p.Knights = Integer.parseInt(token2);
					} else if (token.equals("MagicAxe")) {
						p.MagicAxe = Integer.parseInt(token2);
					} else if (token.equals("DB")) {
						p.DB = Integer.parseInt(token2);
					} else if (token.equals("Bloodveld")) {
						p.Bloodveld = Integer.parseInt(token2);
					} else if (token.equals("HellHound")) {
						p.HellHound = Integer.parseInt(token2);
					} else if (token.equals("CaveCrawler")) {
						p.CaveCrawler = Integer.parseInt(token2);
					} else if (token.equals("CaveBug")) {
						p.CaveBug = Integer.parseInt(token2);
					} else if (token.equals("CaveHorror")) {
						p.CaveHorror = Integer.parseInt(token2);
					} else if (token.equals("Cockatrice")) {
						p.Cockatrice = Integer.parseInt(token2);
					} else if (token.equals("RockSlug")) {
						p.RockSlug = Integer.parseInt(token2);
					} else if (token.equals("Pyrefiend")) {
						p.Pyrefiend = Integer.parseInt(token2);
					} else if (token.equals("Basilisk")) {
						p.Basilisk = Integer.parseInt(token2);
					} else if (token.equals("Jelly")) {
						p.Jelly = Integer.parseInt(token2);
					} else if (token.equals("Turoth")) {
						p.Turoth = Integer.parseInt(token2);
					} else if (token.equals("Kurasks")) {
						p.Kurasks = Integer.parseInt(token2);
					} else if (token.equals("Wariiors")) {
						p.Warriors = Integer.parseInt(token2);
					} else if (token.equals("Wyverns")) {
						p.Wyverns = Integer.parseInt(token2);
					} else if (token.equals("Wild")) {
						p.Wild = Integer.parseInt(token2);
					} else if (token.equals("Slayer")) {
						p.Slayer = Integer.parseInt(token2);
					} else if (token.equals("Boss")) {
						p.Boss = Integer.parseInt(token2);
					} else if (token.equals("Total")) {
						p.Total = Integer.parseInt(token2);
					} else if (token.equals("necromancy-level")) {
						p.nlevel = Integer.parseInt(token2);
					} else if (token.equals("necromancy-xp")) {
						p.nxp = Integer.parseInt(token2);
				...
				/*case 16:
						...
						p.getKillstreak().getKillstreaks().put(type, Integer.parseInt(token2));
					break;*/
	...
	public static boolean saveGame(Player p) {
		...
		//BufferedWriter tradingfile = null;
		try {
			characterfile = new BufferedWriter(new FileWriter(Config.CHARACTER_SAVE_DIRECTORY + p.playerName + ".txt"));
			//tradingfile = new BufferedWriter(new FileWriter(Config.TRADING_SAVE_DIRECTORY + p.playerName + ".txt"));
			/* ACCOUNT */
			...
			characterfile.newLine();
			characterfile.write("maRound = " + Player.maRound);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("bank-charges = ", 0, 15);
			characterfile.write(Integer.toString(p.bankCharges), 0, Integer.toString(p.bankCharges).length());
			characterfile.newLine();
			characterfile.write("augury = ", 0, 9);
			characterfile.write(Integer.toString(p.augury), 0, Integer.toString(p.augury).length());
			characterfile.newLine();
			characterfile.write("rigour = ", 0, 9);
			characterfile.write(Integer.toString(p.rigour), 0, Integer.toString(p.rigour).length());
			characterfile.newLine();
			...
			characterfile.write("necromancy-level = " + p.nlevel);
			characterfile.newLine();
			characterfile.write("necromancy-xp = " + p.nxp);
			characterfile.newLine();
			characterfile.write("pc-points = ", 0, 12);
			characterfile.write(Integer.toString(p.pcPoints), 0, Integer.toString(p.pcPoints).length());
			characterfile.newLine();
			characterfile.write("LogTimer = ", 0, 11);
			characterfile.write(Integer.toString(p.LogTimer), 0, Integer.toString(p.LogTimer).length());
			characterfile.newLine();
			characterfile.write("LogAmount = ", 0, 12);
			characterfile.write(Integer.toString(p.LogAmount), 0, Integer.toString(p.LogAmount).length());
			characterfile.newLine();
			characterfile.write("hasTree = ", 0, 10);
			characterfile.write(Integer.toString(p.hasTree), 0, Integer.toString(p.hasTree).length());
			characterfile.newLine();
			characterfile.write("raked = ", 0, 8);
			characterfile.write(Integer.toString(p.raked), 0, Integer.toString(p.raked).length());
			characterfile.newLine();
			characterfile.write("compost = ", 0, 10);
			characterfile.write(Integer.toString(p.compost), 0, Integer.toString(p.compost).length());
			characterfile.newLine();
			characterfile.write("RockCrabs = ", 0, 12);
			characterfile.write(Integer.toString(p.RockCrabs), 0, Integer.toString(p.RockCrabs).length());
			characterfile.newLine();
			characterfile.write("Cows = ", 0, 7);
			characterfile.write(Integer.toString(p.Cows), 0, Integer.toString(p.Cows).length());
			characterfile.newLine();
			characterfile.write("recentKill = ", 0, 13);
			characterfile.write(Integer.toString(p.recentKill), 0, Integer.toString(p.recentKill).length());
			characterfile.newLine();
			characterfile.write("Yaks = ", 0, 7);
			characterfile.write(Integer.toString(p.Yaks), 0, Integer.toString(p.Yaks).length());
			characterfile.newLine();
			characterfile.write("Bandits = ", 0, 10);
			characterfile.write(Integer.toString(p.Bandits), 0, Integer.toString(p.Bandits).length());
			characterfile.newLine();
			characterfile.write("Elfs = ", 0, 7);
			characterfile.write(Integer.toString(p.Elfs), 0, Integer.toString(p.Elfs).length());
			characterfile.newLine();
			characterfile.write("Dags = ", 0, 7);
			characterfile.write(Integer.toString(p.Dags), 0, Integer.toString(p.Dags).length());
			characterfile.newLine();
			characterfile.write("Dragons = ", 0, 10);
			characterfile.write(Integer.toString(p.Dragons), 0, Integer.toString(p.Dragons).length());
			characterfile.newLine();
			characterfile.write("Gorillas = ", 0, 11);
			characterfile.write(Integer.toString(p.Gorillas), 0, Integer.toString(p.Gorillas).length());
			characterfile.newLine();
			characterfile.write("SmokeDevils = ", 0, 14);
			characterfile.write(Integer.toString(p.SmokeDevils), 0, Integer.toString(p.SmokeDevils).length());
			characterfile.newLine();
			characterfile.write("BarrelChest = ", 0, 14);
			characterfile.write(Integer.toString(p.BarrelChest), 0, Integer.toString(p.BarrelChest).length());
			characterfile.newLine();
			characterfile.write("KBD = ", 0, 6);
			characterfile.write(Integer.toString(p.KBD), 0, Integer.toString(p.KBD).length());
			characterfile.newLine();
			characterfile.write("Mole = ", 0, 7);
			characterfile.write(Integer.toString(p.Mole), 0, Integer.toString(p.Mole).length());
			characterfile.newLine();
			characterfile.write("KQ = ", 0, 5);
			characterfile.write(Integer.toString(p.KQ), 0, Integer.toString(p.KQ).length());
			characterfile.newLine();
			characterfile.write("GWD = ", 0, 6);
			characterfile.write(Integer.toString(p.GWD), 0, Integer.toString(p.GWD).length());
			characterfile.newLine();
			characterfile.write("Corp = ", 0, 7);
			characterfile.write(Integer.toString(p.Corp), 0, Integer.toString(p.Corp).length());
			characterfile.newLine();
			characterfile.write("Kraken = ", 0, 9);
			characterfile.write(Integer.toString(p.Kraken), 0, Integer.toString(p.Kraken).length());
			characterfile.newLine();
			characterfile.write("Zul = ", 0, 6);
			characterfile.write(Integer.toString(p.Zul), 0, Integer.toString(p.Zul).length());
			characterfile.newLine();
			characterfile.write("Cer = ", 0, 6);
			characterfile.write(Integer.toString(p.Cer), 0, Integer.toString(p.Cer).length());
			characterfile.newLine();
			characterfile.write("TSD = ", 0, 6);
			characterfile.write(Integer.toString(p.TSD), 0, Integer.toString(p.TSD).length());
			characterfile.newLine();
			characterfile.write("AbyssalSire = ", 0, 14);
			characterfile.write(Integer.toString(p.AbyssalSire), 0, Integer.toString(p.AbyssalSire).length());
			characterfile.newLine();
			characterfile.write("LM = ", 0, 5);
			characterfile.write(Integer.toString(p.LM), 0, Integer.toString(p.LM).length());
			characterfile.newLine();
			characterfile.write("Vork = ", 0, 7);
			characterfile.write(Integer.toString(p.Vork), 0, Integer.toString(p.Vork).length());
			characterfile.newLine();
			characterfile.write("Rats = ", 0, 7);
			characterfile.write(Integer.toString(p.Rats), 0, Integer.toString(p.Rats).length());
			characterfile.newLine();
			characterfile.write("HobGoblins = ", 0, 13);
			characterfile.write(Integer.toString(p.HobGoblin), 0, Integer.toString(p.HobGoblin).length());
			characterfile.newLine();
			characterfile.write("Giants = ", 0, 9);
			characterfile.write(Integer.toString(p.Giants), 0, Integer.toString(p.Giants).length());
			characterfile.newLine();
			characterfile.write("Demons = ", 0, 9);
			characterfile.write(Integer.toString(p.Demons), 0, Integer.toString(p.Demons).length());
			characterfile.newLine();
			characterfile.write("Skeletons = ", 0, 12);
			characterfile.write(Integer.toString(p.Skeletons), 0, Integer.toString(p.Skeletons).length());
			characterfile.newLine();
			characterfile.write("Ghosts = ", 0, 9);
			characterfile.write(Integer.toString(p.Ghosts), 0, Integer.toString(p.Ghosts).length());
			characterfile.newLine();
			characterfile.write("Bats = ", 0, 7);
			characterfile.write(Integer.toString(p.Bats), 0, Integer.toString(p.Bats).length());
			characterfile.newLine();
			characterfile.write("Dwarfs = ", 0, 9);
			characterfile.write(Integer.toString(p.Dwarfs), 0, Integer.toString(p.Dwarfs).length());
			characterfile.newLine();
			characterfile.write("Druids = ", 0, 9);
			characterfile.write(Integer.toString(p.Druids), 0, Integer.toString(p.Druids).length());
			characterfile.newLine();
			characterfile.write("Knights = ", 0, 10);
			characterfile.write(Integer.toString(p.Knights), 0, Integer.toString(p.Knights).length());
			characterfile.newLine();
			characterfile.write("MagicAxe = ", 0, 11);
			characterfile.write(Integer.toString(p.MagicAxe), 0, Integer.toString(p.MagicAxe).length());
			characterfile.newLine();
			characterfile.write("DB = ", 0, 5);
			characterfile.write(Integer.toString(p.DB), 0, Integer.toString(p.DB).length());
			characterfile.newLine();
			characterfile.write("Bloodveld = ", 0, 12);
			characterfile.write(Integer.toString(p.Bloodveld), 0, Integer.toString(p.Bloodveld).length());
			characterfile.newLine();
			characterfile.write("HellHound = ", 0, 12);
			characterfile.write(Integer.toString(p.HellHound), 0, Integer.toString(p.HellHound).length());
			characterfile.newLine();
			characterfile.write("CaveCrawler = ", 0, 14);
			characterfile.write(Integer.toString(p.CaveCrawler), 0, Integer.toString(p.CaveCrawler).length());
			characterfile.newLine();
			characterfile.write("CaveBug = ", 0, 10);
			characterfile.write(Integer.toString(p.CaveBug), 0, Integer.toString(p.CaveBug).length());
			characterfile.newLine();
			characterfile.write("CaveHorror = ", 0, 13);
			characterfile.write(Integer.toString(p.CaveHorror), 0, Integer.toString(p.CaveHorror).length());
			characterfile.newLine();
			characterfile.write("Cockatrice = ", 0, 13);
			characterfile.write(Integer.toString(p.Cockatrice), 0, Integer.toString(p.Cockatrice).length());
			characterfile.newLine();
			characterfile.write("RockSlug = ", 0, 11);
			characterfile.write(Integer.toString(p.RockSlug), 0, Integer.toString(p.RockSlug).length());
			characterfile.newLine();
			characterfile.write("Pyrefiend = ", 0, 12);
			characterfile.write(Integer.toString(p.Pyrefiend), 0, Integer.toString(p.Pyrefiend).length());
			characterfile.newLine();
			characterfile.write("Basilisk = ", 0, 11);
			characterfile.write(Integer.toString(p.Basilisk), 0, Integer.toString(p.Basilisk).length());
			characterfile.newLine();
			characterfile.write("Jelly = ", 0, 8);
			characterfile.write(Integer.toString(p.Jelly), 0, Integer.toString(p.Jelly).length());
			characterfile.newLine();
			characterfile.write("Turoth = ", 0, 9);
			characterfile.write(Integer.toString(p.Turoth), 0, Integer.toString(p.Turoth).length());
			characterfile.newLine();
			characterfile.write("Kurasks = ", 0, 10);
			characterfile.write(Integer.toString(p.Kurasks), 0, Integer.toString(p.Kurasks).length());
			characterfile.newLine();
			characterfile.write("Warriors = ", 0, 11);
			characterfile.write(Integer.toString(p.Warriors), 0, Integer.toString(p.Warriors).length());
			characterfile.newLine();
			characterfile.write("Wyverns = ", 0, 10);
			characterfile.write(Integer.toString(p.Wyverns), 0, Integer.toString(p.Wyverns).length());
			characterfile.newLine();
			characterfile.write("Wild = ", 0, 7);
			characterfile.write(Integer.toString(p.Wild), 0, Integer.toString(p.Wild).length());
			characterfile.newLine();
			characterfile.write("Slayer = ", 0, 9);
			characterfile.write(Integer.toString(p.Slayer), 0, Integer.toString(p.Slayer).length());
			characterfile.newLine();
			characterfile.write("Boss = ", 0, 7);
			characterfile.write(Integer.toString(p.Boss), 0, Integer.toString(p.Boss).length());
			characterfile.newLine();
			characterfile.write("Total = ", 0, 8);
			characterfile.write(Integer.toString(p.Total), 0, Integer.toString(p.Total).length());
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("lost-items-hydra = ");
			for (GameItem item : p.getHydraLostItems()) {
				if (item == null) {
					continue;
				}
				characterfile.write(item.getId() + "\t" + item.getAmount() + "\t");
			...
			characterfile.write("[CONSTRUCTION]");
			characterfile.newLine();
			characterfile.write("isInHouse = " + p.isInHouse);
			characterfile.newLine();
			characterfile.write("hasHouse = " + p.hasHouse);
			characterfile.newLine();
			characterfile.newLine();
