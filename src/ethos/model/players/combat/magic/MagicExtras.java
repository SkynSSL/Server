		...
		if (PlayerHandler.players[playerId] != null) {
			...
			if (c.getCombat().checkMultiBarrageReqs(playerId)) {
				...
				if (Misc.random(c.getCombat().mageAtk()) > Misc.random(c2.getCombat().mageDef()) && !c.magicFailed) {
					...
					c.getPA().addSkillXP((int) MagicData.MAGIC_SPELLS[c.oldSpellId][7] + damage, Config.MAGIC, true);
					c.getPA().addSkillXP((int) MagicData.MAGIC_SPELLS[c.oldSpellId][7] + damage / 3, Config.HITPOINTS, true);
