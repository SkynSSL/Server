...
public class MeleeData {
	...
	public static void getPlayerAnimIndex(Player c, String weaponName) {
		...
		if (weaponName.contains("ahrim") || weaponName.contains("scythe") || weaponName.contains("dragon hunter lance")) {
			c.playerStandIndex = 809;
			c.playerWalkIndex = 1146;
			c.playerRunIndex = 1210;
			return;
		...
		if (weaponName.contains("wand") || weaponName.contains("staff") || weaponName.contains("trident") || weaponName.contains("rapier")) {
			c.playerStandIndex = 809;
			c.playerRunIndex = 1210;
			c.playerWalkIndex = 1146;
			return;
	...
	public static int getWepAnim(Player c, String weaponName) {
		...
		if (weaponName.contains("dragon hunter lance")) {
			return 400;
		}
		if (weaponName.contains("ballista")) {
			return 7218;
		...
		if (weaponName.contains("2h sword") || weaponName.contains("godsword") || weaponName.contains("saradomin sword") || weaponName.contains("blessed sword") || weaponName.contains("large spade")) {
			switch (c.fightMode) {
			case 0:// attack
				return 7045;
			case 2:// str
