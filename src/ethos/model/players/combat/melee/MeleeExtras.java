...
public class MeleeExtras {
	...
	public static void applyRecoilNPC(Player c, int damage, int i) {
		if (damage <= 0) 
			return;
		if (damage > 0 && c.playerEquipment[c.playerRing] == 2550 || c.playerEquipment[c.playerRing] == 19550 || c.playerEquipment[c.playerRing] == 19710) {
	...
	public static void applyRecoil(Player c, int damage, int i) {
		...
		if (damage > 0 && PlayerHandler.players[i].playerEquipment[c.playerRing] == 2550 || c.playerEquipment[c.playerRing] == 19550 || c.playerEquipment[c.playerRing] == 19710) {
