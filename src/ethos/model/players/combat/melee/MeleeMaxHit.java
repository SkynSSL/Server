...
public class MeleeMaxHit {
	...
	public static double calculateBaseDamage(Player c, boolean special) {
		...
		if (c.npcIndex > 0 && c.getItems().isWearingItem(22324)) {
			strength += 1.3;
		}
		if (c.npcIndex > 0 && c.getItems().isWearingItem(22504)) {
			strength += 1.3;
		}
		if (c.npcIndex > 0 && c.getItems().isWearingItem(22505)) {
			strength += 1.2;
		}
		if (c.npcIndex > 0 && c.getItems().isWearingItem(22506)) {
			strength += 1.3;
		}
		if (c.npcIndex > 0 && c.getItems().isWearingItem(22978)) {
			strength += 1.8;
		}
		if (c.prayerActive[1]) {
