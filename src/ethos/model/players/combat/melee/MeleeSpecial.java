...
public class MeleeSpecial {
	...
	public static void activateSpecial(Player c, int weapon, int i) {
		...
		//case 22505: //sword
		//	c.startAnimation(7295);
		//	c.specAccuracy = 2.0; 
		//	c.hitDelay = c.getCombat().getHitDelay(i, ItemAssistant.getItemName(c.playerEquipment[c.playerWeapon]).toLowerCase()+1); c.specDamage = 1.25;
		//	 break;
		case 12848:
		case 4153: // maul
			if (c.isDead)
