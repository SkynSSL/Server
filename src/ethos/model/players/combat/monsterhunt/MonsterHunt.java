...
public class MonsterHunt {
	...
	public enum Npcs {
		...
		GLOD(5129, "Glod", 3500, 98, 450,600);
	...
	public static void spawnNPC() {
		CycleEventHandler.getSingleton().addEvent(spawned, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				PlayerHandler.executeGlobalMessage("[@red@PK@bla@] The @red@" + randomNpc.getMonsterName() + " @bla@has been spotted near @red@" + randomLocation.getLocationName() + "@bla@.");
				spawned = true;
			}
