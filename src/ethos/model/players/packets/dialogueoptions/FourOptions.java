...
public class FourOptions {
	...
	public static void handleOption1(Player c) {
		...
		switch (c.dialogueAction) {
						case 8768:
			c.getOL().makeOverLoad(c, 1);
			break;
				case 9223:
			c.getGC().cutGem(c, "Amulet", c.getGC().Gems[0]);
			c.getPA().closeAllWindows();
			break;
		case 9224:
			c.getGC().cutGem(c, "Amulet", c.getGC().Gems[1]);
			c.getPA().closeAllWindows();
			break;
		case 9225:
			c.getGC().cutGem(c, "Amulet", c.getGC().Gems[2]);
			c.getPA().closeAllWindows();
			break;
		case 9226:
			c.getGC().cutGem(c, "Amulet", c.getGC().Gems[3]);
			c.getPA().closeAllWindows();
			break;
		case 9227:
			c.getGC().cutGem(c, "Amulet", c.getGC().Gems[4]);
			c.getPA().closeAllWindows();
			break;
		case 9228:
			c.getGC().cutGem(c, "Amulet", c.getGC().Gems[5]);
			c.getPA().closeAllWindows();
			break;
		case 15001:
			if (c.hasHouse) {
				c.getDH().sendDialogues(15002, 5419);
			} else {
				c.getDH().sendDialogues(15003, 5419);
			}
			break;
	...
	public static void handleOption2(Player c) {
		switch (c.dialogueAction) {
						case 8768:
			c.getOL().makeOverLoad(c, 2);
			break;
				case 9223:
			c.getGC().cutGem(c, "Bracelet", c.getGC().Gems[0]);
			c.getPA().closeAllWindows();
			break;
		case 9224:
			c.getGC().cutGem(c, "Bracelet", c.getGC().Gems[1]);
			c.getPA().closeAllWindows();
			break;
		case 9225:
			c.getGC().cutGem(c, "Bracelet", c.getGC().Gems[2]);
			c.getPA().closeAllWindows();
			break;
		case 9226:
			c.getGC().cutGem(c, "Bracelet", c.getGC().Gems[3]);
			c.getPA().closeAllWindows();
			break;
		case 9227:
			c.getGC().cutGem(c, "Bracelet", c.getGC().Gems[4]);
			c.getPA().closeAllWindows();
			break;
		case 9228:
			c.getGC().cutGem(c, "Bracelet", c.getGC().Gems[5]);
			c.getPA().closeAllWindows();
			break;
		case 15001:
			if (c.hasHouse) {
				...
				c.getPA().closeAllWindows();
				c.sendMessage("You do not have a house, buy one from the Estate Agent!");
			}
			break;
	...
	public static void handleOption3(Player c) {
		switch (c.dialogueAction) {
						case 8768:
			c.getOL().makeOverLoad(c, 3);
			break;
				case 9223:
			c.getGC().cutGem(c, "Necklace", c.getGC().Gems[0]);
			c.getPA().closeAllWindows();
			break;
		case 9224:
			c.getGC().cutGem(c, "Necklace", c.getGC().Gems[1]);
			c.getPA().closeAllWindows();
			break;
		case 9225:
			c.getGC().cutGem(c, "Necklace", c.getGC().Gems[2]);
			c.getPA().closeAllWindows();
			break;
		case 9226:
			c.getGC().cutGem(c, "Necklace", c.getGC().Gems[3]);
			c.getPA().closeAllWindows();
			break;
		case 9227:
			c.getGC().cutGem(c, "Necklace", c.getGC().Gems[4]);
			c.getPA().closeAllWindows();
			break;
		case 9228:
			c.getGC().cutGem(c, "Necklace", c.getGC().Gems[5]);
			c.getPA().closeAllWindows();
			break;
		case 6500:
	...
	public static void handleOption4(Player c) {
		switch (c.dialogueAction) {
						case 8768:
			c.getOL().makeOverLoad(c, 4);
			break;
		case 9223:
			c.getGC().cutGem(c, "Ring", c.getGC().Gems[0]);
			c.getPA().closeAllWindows();
			break;
		case 9224:
			c.getGC().cutGem(c, "Ring", c.getGC().Gems[1]);
			c.getPA().closeAllWindows();
			break;
		case 9225:
			c.getGC().cutGem(c, "Ring", c.getGC().Gems[2]);
			c.getPA().closeAllWindows();
			break;
		case 9226:
			c.getGC().cutGem(c, "Ring", c.getGC().Gems[3]);
			c.getPA().closeAllWindows();
			break;
		case 9227:
			c.getGC().cutGem(c, "Ring", c.getGC().Gems[4]);
			c.getPA().closeAllWindows();
			break;
		case 9228:
			c.getGC().cutGem(c, "Ring", c.getGC().Gems[5]);
			c.getPA().closeAllWindows();
			break;
		case 6500:
			c.getPA().closeAllWindows();
