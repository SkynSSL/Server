...
public class Resetdaily extends Command {
	...
	public void execute(Player player, String input) {
		...
		player.sendMessage("dailyTaskDate: " + player.dailyTaskDate + " | totalDailyDonate: "+ player.totalDailyDone +" | dailyTask: None | completedDailyTask: "+ player.completedDailyTask +"");
	}
