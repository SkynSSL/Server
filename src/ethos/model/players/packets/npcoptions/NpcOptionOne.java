...
public class NpcOptionOne {
	...
	public static void handleOption(Player player, int npcType) {
		...
		//player.sendMessage("Clicked Object Option 2:  "+npcType+"");
		switch (npcType) {
	...
	break;
		...
		case 276: //bonus drops
			if (Config.BONUS_XP_WOGW = true) {
				...
				player.getDH().sendNpcChat1("Well of Goodwill is currently @red@inactive@bla@!", 276, Config.SERVER_NAME+" Crier");
			}
			break;
		case 5520:
		...
		case 3341:
			...
			break;
		case 504: //agility
			player.getDH().sendDialogues(503, npcType);
			break;
		case 5919: //agility
		...
		case 507:
			...
			case 5449:
			player.getDH().sendDialogues(8765, npcType);
			break;
