...
public class Boundary {
	 ...
	 * Diary locations
	 */
	public static final Boundary RAIDSTWO = new Boundary(3101, 4203, 3369, 4503);
	public static final Boundary ROCK_CRAB = new Boundary(2662, 3705, 2690, 3738);
	public static final Boundary NECRO = new Boundary(3484, 3215, 3527, 3257);
	...
	public static final Boundary HYDRA = new Boundary(1334,10216,1415,10300);
...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary EDGE_BANK = new Boundary(1496, 3620, 1513, 3613);
	public static final Boundary HOME = new Boundary(3076, 3457, 3132, 3520);
	...
	public static final Boundary EDGEVILLE_PERIMETER = new Boundary(1554, 3645, 1468, 3556);
