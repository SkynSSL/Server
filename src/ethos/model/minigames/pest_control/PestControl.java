...
public class PestControl {
	...
	private static final int LOBBY_TIME = 40;

	private static final int PLAYERS_REQUIRED = 1;

	private static final int POINT_REWARD = 7;

	public static final int MINIMUM_DAMAGE = 25;
				...
				if (gameMembers.get(i) != null) {
					if (Boundary.isIn(gameMembers.get(i), GAME_BOUNDARY)) {
						...
						if (player.pestControlDamage > MINIMUM_DAMAGE) {
							...
							int point_reward = Config.BONUS_PC == true && Config.BONUS_PC_WOGW == true ? 22 : 
											   Config.BONUS_PC == false && Config.BONUS_PC_WOGW == true ? 12 : 
											   Config.BONUS_PC == true && Config.BONUS_PC_WOGW == false ? 12 : POINT_REWARD;
