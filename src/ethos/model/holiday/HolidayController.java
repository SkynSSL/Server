...
public class HolidayController {
	...
	public static final Halloween HALLOWEEN = new Halloween("Halloween", new GregorianCalendar(Server.getCalendar().getInstance().get(Calendar.YEAR), Calendar.SEPTEMBER, 27, 0, 0),
			new GregorianCalendar(Server.getCalendar().getInstance().get(Calendar.YEAR), Calendar.DECEMBER, 1, 0, 0), new HalloweenCycleEvent());
