...
public class HalloweenSearchGame {
	...
	public void updateZombies() {
		...
		case 0:
			NPCHandler.spawnNpc(6462, 2973, 2776, 0, 1, 90, 8, 150, 200);
			NPCHandler.spawnNpc(6462, 2969, 2773, 0, 1, 90, 8, 150, 200);
			NPCHandler.spawnNpc(6462, 2966, 2771, 0, 1, 90, 8, 150, 200);
			NPCHandler.spawnNpc(6465, 2974, 2771, 0, 1, 100, 13, 150, 200);
			NPCHandler.spawnNpc(6465, 2968, 2768, 0, 1, 100, 13, 150, 200);
			NPCHandler.spawnNpc(6462, 2974, 2768, 0, 1, 90, 8, 150, 200);
			NPCHandler.spawnNpc(6462, 2968, 2763, 0, 1, 90, 8, 150, 200);
		...
		case 1:
			...
			NPCHandler.spawnNpc(6462, 2955, 2787, 0, 1, 90, 8, 150, 200);
	...
	public void receive(Player player, int x, int y) {
		...
		if (player.getHolidayStages().getStage("Halloween") < 4) {
			player.sendMessage("You must talk to the Demon Butler before stealing from this container.");
			return;
		}
		if (remaining <= 0) {
