...
public class PetHandler {
    ...
    public static enum Pets {
        ...
        CHAOS(11995, 5907, "Chaos Elemental", 500, "second"),
    ...
    public static void receive(Player player, NPC npc) {
        ...
        pet.ifPresent(p -> {
            ...
            if (RandomUtils.nextInt(0, p.droprate) == 1) {
                ...
                PlayerHandler.executeGlobalMessage("[@red@Lootations@bla@]@blu@ @cr9@ <col=255><img="+rights+">" + Misc.formatPlayerName(player.playerName) + "</col> received a pet drop from @blu@"  + p.parent + ".");
                DiscordMessager.sendLootations("[Lootations] " + Misc.formatPlayerName(player.playerName) + " received a pet drop from "  + p.parent + ".");
            }
        });
