...
public enum SkillcapePerks {
		...
		ISARADOMIN_MAX_CAPE(new int[][] { { 21776 } }),
		ZAMORAK_MAX_CAPE(new int[][] { { 13333 } }),
		IZAMORAK_MAX_CAPE(new int[][] { { 21780 } }),
		GUTHIX_MAX_CAPE(new int[][] { { 13335 } }),
		IGUTHIX_MAX_CAPE(new int[][] { { 21784 } }),
		INFERNAL(new int[][] { { 21295 } });
	
	public static final int[] MAX_CAPE_IDS = { 13280, 21898, 13329, 13337, 13331, 13333, 13335, 20760, 21285 };
		
	public static final SkillcapePerks[] MAX_CAPES = { MAX_CAPE, ARDOUGNE_MAX_CAPE, FIRE_MAX_CAPE, AVAS_MAX_CAPE, ASSEMBLER_MAX_CAPE, SARADOMIN_MAX_CAPE, ISARADOMIN_MAX_CAPE, ZAMORAK_MAX_CAPE, GUTHIX_MAX_CAPE, INFERNAL };
	...
	public static void mixCape(Player player, String cape) {
		...
		case "INFERNAL":
			...
			player.getDH().sendItemStatement("You've combined the infernal cape and max cape.", 21285);
			break;
		...
		case "FIRE":
			...
			case "SARADOMINi":
				...
				player.getDH().sendItemStatement("You've combined the Imbued saradomin cape and max cape.", 21776);
				break;
			...
			case "ZAMORAKi":
				...
				player.getDH().sendItemStatement("You've combined the Imbued zamorak cape and max cape.", 21780);
				break;
			...
			case "GUTHIXi":
				...
				player.getDH().sendItemStatement("You've combined the Imbued guthix cape and max cape.", 21784);
				break;
		...
		case "ASSEMBLER":
			...
			player.getDH().sendItemStatement("You've combined the assembler and max cape.", 21898);
			break;
