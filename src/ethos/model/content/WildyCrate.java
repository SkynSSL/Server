...
public class WildyCrate extends CycleEvent {
	...
	static {
		items.put(Rarity.COMMON, 
			Arrays.asList(
					new GameItem(565, 5000),
					new GameItem(12746),
					new GameItem(560, 5000), 
					new GameItem(11937, Misc.random(150) + 100),
					new GameItem(2996, Misc.random(20) + 5), 
					new GameItem(19685), 
					new GameItem(4153, Misc.random(5) + 5), 
					new GameItem(1128, 5), 
					new GameItem(1080, 5),
					new GameItem(4588, 5),
					new GameItem(11730),
					new GameItem(13307, Misc.random(100) + 50), 
		...
		items.put(Rarity.UNCOMMON,
				Arrays.asList(
						...
						new GameItem(13307, Misc.random(200) + 100),
						new GameItem(20777))
			...
			items.put(Rarity.RARE,
					Arrays.asList(
							...
							new GameItem(13307, Misc.random(400) + 200),
