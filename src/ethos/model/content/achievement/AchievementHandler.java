...
public class AchievementHandler {
    ...
    void setComplete(int tier, int index, boolean state) {
        this.completed[tier][index] = state;
    }

    int getAmountRemaining(int tier, int index) {
        return amountRemaining[tier][index];
    }

    void setAmountRemaining(int tier, int index, int amountRemaining) {
