...
import ethos.model.content.DeadlyChest;
...
public class UseItem {
	...
	public static void ItemonObject(Player c, int objectID, int objectX, int objectY, int itemId) {
		...
		switch (objectID) {
					case 32158:
			if(itemId == c.getGC().Gems[0]) {
			c.getDH().sendDialogues(9223, -1);
		}
		if(itemId == c.getGC().Gems[1]) {
			c.getDH().sendDialogues(9224, -1);
		}
		if(itemId == c.getGC().Gems[2]) {
			c.getDH().sendDialogues(9225, -1);
		}
		if(itemId == c.getGC().Gems[3]) {
			c.getDH().sendDialogues(9226, -1);
		}
		if(itemId == c.getGC().Gems[4]) {
			c.getDH().sendDialogues(9227, -1);
		}
		if(itemId == c.getGC().Gems[5]) {
			c.getDH().sendDialogues(9228, -1);
		}
		if(itemId == c.getGC().Gems[0]) {
			c.getDH().sendDialogues(9223, -1);
		}
		...
		case 2097:
			...
			case 11286:
					if (c.playerLevel[Player.playerSmithing] >= 90) {
						...
						c.getPA().addSkillXP((int) 500, Player.playerSmithing, true);
					} else {
						c.sendMessage("You need a smithing level of 90 to create a dragonfire shield.");
					}
			case 22006:
				if (c.playerLevel[Player.playerSmithing] >= 90) {
					if (!c.getItems().playerHasItem(1540) || !c.getItems().playerHasItem(22006) || !c.getItems().playerHasItem(2347)) {
						c.sendMessage("You must have a skeletal visage, dragonfire shield and a hammer in order to do this.");
						return;
					}
					c.startAnimation(898);
					c.getItems().deleteItem(1540, c.getItems().getItemSlot(1540), 1);
					...
					c.getPA().addSkillXP((int) 2500, Player.playerSmithing, true);
				} else {
	...
	public static void ItemonItem(final Player c, final int itemUsed, final int useWith, final int itemUsedSlot, final int usedWithSlot) {
		...
		if (itemUsed == 1743 && useWith == 1733/* || itemUsed == 1733 || useWith == 1743*/) {
			...
			if (c.playerLevel[12] >= 28) {
				...
				c.getPA().addSkillXP((int) 35, 12, true);
...
//		}          
		...
		case 12640:
			if (itemUsed == 12640 || itemUsed == 3016) {
				...
				c.getPA().addSkillXP((int) 152, Skill.HERBLORE.getId(), true);
		...
		case 11941:
			if (c.getItems().isStackable(itemUsed)) {
				c.getLootingBag().deposit(itemUsed, 2147000000);
				break;
			}
		...
		if (itemUsed == 6949 && useWith == 6737 || itemUsed == 6737 && useWith == 6949) {
			if (c.getItems().playerHasItem(6737) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(11773, 1);
				c.sendMessage("You imbue your berserker ring, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 6733 || itemUsed == 6733 && useWith == 6949) {
			if (c.getItems().playerHasItem(6733) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(11771, 1);
				c.sendMessage("You imbue your archer's ring, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 6731 || itemUsed == 6731 && useWith == 6949) {
			if (c.getItems().playerHasItem(6731) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(11770, 1);
				c.sendMessage("You imbue your seer's ring, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 6735 || itemUsed == 6735 && useWith == 6949) {
			if (c.getItems().playerHasItem(6735) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(11772, 1);
				c.sendMessage("You imbue your warrior ring, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 12605 || itemUsed == 12605 && useWith == 6949) {
			if (c.getItems().playerHasItem(12605) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(12692, 1);
				c.sendMessage("You imbue your treasonous ring, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 12603 || itemUsed == 12603 && useWith == 6949) {
			if (c.getItems().playerHasItem(12603) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(12691, 1);
				c.sendMessage("You imbue your tyrannical ring, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 19550 || itemUsed == 19550 && useWith == 6949) {
			if (c.getItems().playerHasItem(19550) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(19710, 1);
				c.sendMessage("You imbue your ring of suffering, consuming the scroll");
			}
		}
		if (itemUsed == 6949 && useWith == 21739 || itemUsed == 21739 && useWith == 6949) {
			if (c.getItems().playerHasItem(21739) && c.getItems().playerHasItem(6949)) {
				c.getItems().deleteItem2(itemUsed, 1);
				c.getItems().deleteItem2(useWith, 1);
				c.getItems().addItem(21752, 1);
				c.sendMessage("You imbue your granite ring, consuming the scroll");
			}
		}
		...
		if(itemUsed == 7980 && useWith == 11865) {//Black i
		...
		if(itemUsed == 7981 && useWith == 11865) {//Green i
		...
		if(itemUsed == 7979 && useWith == 11865) {//Red i
		...
		if(itemUsed == 21275 && useWith == 11865) {//Purple i
		...
		if(itemUsed == 2425 && useWith == 11865) {//Bluei
		...
		if (Crushable.crushIngredient(c, itemUsed, useWith)) {
			return;
				...
				if(useWith == c.getGC().Gems[0] && itemUsed == c.getGC().Chisel) {
			c.getDH().sendDialogues(9223, -1);
		}
		if(useWith == c.getGC().Gems[1] && itemUsed == c.getGC().Chisel) {
			c.getDH().sendDialogues(9224, -1);
		}
		if(useWith == c.getGC().Gems[2] && itemUsed == c.getGC().Chisel) {
			c.getDH().sendDialogues(9225, -1);
		}
		if(useWith == c.getGC().Gems[3] && itemUsed == c.getGC().Chisel) {
			c.getDH().sendDialogues(9226, -1);
		}
		if(useWith == c.getGC().Gems[4] && itemUsed == c.getGC().Chisel) {
			c.getDH().sendDialogues(9227, -1);
		}
		if(useWith == c.getGC().Gems[5] && itemUsed == c.getGC().Chisel) {
			c.getDH().sendDialogues(9228, -1);
		}
		if(itemUsed == c.getGC().Gems[0] && useWith == c.getGC().Chisel) {
			c.getDH().sendDialogues(9223, -1);
		}
		if(itemUsed == c.getGC().Gems[1] && useWith == c.getGC().Chisel) {
			c.getDH().sendDialogues(9224, -1);
		}
		if(itemUsed == c.getGC().Gems[2] && useWith == c.getGC().Chisel) {
			c.getDH().sendDialogues(9225, -1);
		}
		if(itemUsed == c.getGC().Gems[3] && useWith == c.getGC().Chisel) {
			c.getDH().sendDialogues(9226, -1);
		}
		if(itemUsed == c.getGC().Gems[4] && useWith == c.getGC().Chisel) {
			c.getDH().sendDialogues(9227, -1);
		}
		if(itemUsed == c.getGC().Gems[5] && useWith == c.getGC().Chisel) {
			c.getDH().sendDialogues(9228, -1);
		}
		...
		if (itemUsed == 269 || useWith == 12907) {
			...
			if (c.getItems().playerHasItem(269) && c.getItems().playerHasItem(12907)) {
				...
				c.getPA().addSkillXP((int) 125, Skill.HERBLORE.getId(), true);
...
//		}
	...
	public static void ItemonNpc(Player player, int itemId, int npcId, int slot) {
		...
		//		Packs.openDharokSet(player, 12877);
		//		Packs.openAhrimsSet(player, 12881);
		//		Packs.openVeracSet(player, 12875);
		//		Packs.openKarilsSet(player, 12883);
		//		Packs.openToragsSet(player, 12879);
		//		Packs.openGuthansSet(player, 12873);
		//	break;
