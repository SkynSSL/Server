...
public class ItemAssistant {
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		if (WeaponName.equals("Unarmed")) {
			...
			c.getPA().sendFrame126(WeaponName, 331);
		} else if (WeaponName.equals("vitur")) {
			c.setSidebarInterface(0, 8460); // jab, swipe, fend
			...
			c.getPA().sendFrame246(8461, 200, Weapon);
			c.getPA().sendFrame126(WeaponName, 8463);
		} else if (WeaponName2.startsWith("spear") || c.playerEquipment[c.playerWeapon] == 22506 || 
		...
		} else if (WeaponName2.contains("warhammer") || c.playerEquipment[c.playerWeapon] == 4153 || c.playerEquipment[c.playerWeapon] == 13263 || c.playerEquipment[c.playerWeapon] == 12848 || c.playerEquipment[c.playerWeapon] == 22504) {
	 ...
	 **/
	private void specialAmount(int weapon, double specAmount, int barId) {
		c.specBarId = barId;
	...
	public void updateSpecialBar() {
		...
		c.getPA().sendSpecialAttack(Integer.parseInt(percent), c.usingSpecial ? 1 : 0);
