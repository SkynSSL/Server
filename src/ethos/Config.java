...
public class Config {
	...
	public static String SERVER_NAME = "Skyscape Live";
	public static String SERVER_URL = "http://www.skyscapelive.com/";
	public static String FORUM_URL = SERVER_URL;
	public static String DISCORD_URL = SERVER_URL;
	public static String VOTE_URL = "http://www.tojad.everythingrs.com/services/vote";
	public static String STORE_URL = "http://www.tojad.everythingrs.com/services/store";

	public static int PLAYERMODIFIER = 0;

	// Make sure this matches client version
	public static final int CLIENT_VERSION = 58985;
	...
	public static String TRADING_SAVE_DIRECTORY = "Data/tradingpost/players/";
	 ...
	 */
	public static final int ITEM_LIMIT = 43000;
	 ...
	 */
	public static final int[] ITEM_SELLABLE = { 9927,19730, 12020, 6713, 13307, 13571, 12013, 12014, 12015, 12016, 20008, 776, 10071, 13258, 132259,
	 ...
	 */
	public static final int[] NOT_SHAREABLE = { 21266, 21888, 21264, 21900, 21282, 20764, 21786, 21782, 21778, 21898, 21784, 21780, 21776, 21285, 8152, 9927,11899,22109,13258, 13259, 13260, 13261, 19730, 12020, 6713, 12013, 10071,
			...
			12323, 12325, 12516, 21043, 19675 ,21273,21197,21295,12638,12639,12637,11889,6529,10551,10548,7462,21791,21793,21795,2425,299,21992,22376,22378,22380,22382};
	/**
	...
	public static final int[] ITEMS_KEPT_ON_DEATH = { 9927,8025,22109,21285,12791,6713, 12013, 10071, 12014, 12015, 12016, 20008, 776, 13258,
			...
			21898, 13338, 13181, 11850, 11852, 11854, 11856, 11858, 11860, 13181, 5733, 775, 9958, 9959, 12840, 12648, 13116,
			13072, 13073, 7509, 4081, 8841, 4202, 2415, 2416, 2417, 12921, 12810, 12811, 12812, 12813, 12814, 12815,
			11919, 12956, 12957, 12958, 12959, 15573, 8135, 11864, 11865, 12432, 12373, 12379, 12369,
			...
			8847, 8848, 8849, 8850, 10548, 7462, 7461, 7460, 7459, 7458, 7457, 7456, 7455, 7582, 15572, 12855,
			12856, 13274, 13275, 13276, 19675,21295,12638,12639,12637,11889,12954,10551,10548,21791,21793,21795,21786,21784,21782,21780,21778,21776 , 21992};
	/**
	...
	public static final String[] UNSPAWNABLE = { "ahrim", "reindeer", "star bauble", "bauble", "torag", "dharok",
			...
			"3rd", "third", "bomb", "karamb", "guthan", "verac", "void", "uncut", "Onyx", "onyx amulet",
	...
	public static final int[] DRAGON_IDS = { 137, 139, 239, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258,
			259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 2642, 2918, 2919, 4000,
			4385, 5878, 5879, 2880, 2881, 5882, 6500, 6501, 6502, 6593, 7253, 7254, 7255, 7273, 7274, 7275, 8026, 8027, 8028 };
	...
	public static final int FARMING = 12;
	 ...
	 */
    public static final int ATTACK_EXPERIENCE = 1;
    public static final int DEFENCE_EXPERIENCE = 1;
    public static final int STRENGTH_EXPERIENCE = 1;
    public static final int HITPOINTS_EXPERIENCE = 1;
    public static final int RANGED_EXPERIENCE = 1;
	public static final int PRAYER_EXPERIENCE = 25;
	public static final int MAGIC_EXPERIENCE = 1;
	...
	public static final int CONSTRUCTION_EXPERIENCE = 1;
	public static final int HUNTER_EXPERIENCE = 20;

    public static int XpMultiplier(int skill_id) {
        Map<Integer, Integer> xpRates = new HashMap<>();
        xpRates.put(ATTACK, ATTACK_EXPERIENCE);
        xpRates.put(DEFENCE, DEFENCE_EXPERIENCE);
        xpRates.put(STRENGTH, STRENGTH_EXPERIENCE);
        xpRates.put(HITPOINTS, HITPOINTS_EXPERIENCE);
        xpRates.put(RANGED, RANGED_EXPERIENCE);
        xpRates.put(PRAYER, PRAYER_EXPERIENCE);
        xpRates.put(MAGIC, MAGIC_EXPERIENCE);
        xpRates.put(COOKING, COOKING_EXPERIENCE);
        xpRates.put(WOODCUTTING, WOODCUTTING_EXPERIENCE);
        xpRates.put(FLETCHING, FLETCHING_EXPERIENCE);
        xpRates.put(FISHING, FISHING_EXPERIENCE);
        xpRates.put(FIREMAKING, FIREMAKING_EXPERIENCE);
        xpRates.put(CRAFTING, CRAFTING_EXPERIENCE);
        xpRates.put(SMITHING, SMITHING_EXPERIENCE);
        xpRates.put(MINING, MINING_EXPERIENCE);
        xpRates.put(HERBLORE, HERBLORE_EXPERIENCE);
        xpRates.put(AGILITY, AGILITY_EXPERIENCE);
        xpRates.put(THIEVING, THIEVING_EXPERIENCE);
        xpRates.put(SLAYER, SLAYER_EXPERIENCE);
        xpRates.put(FARMING, FARMING_EXPERIENCE);
        xpRates.put(RUNECRAFTING, RUNECRAFTING_EXPERIENCE);
        xpRates.put(CONSTRUCTION, CONSTRUCTION_EXPERIENCE);
        xpRates.put(HUNTER, HUNTER_EXPERIENCE);
        return xpRates.get(skill_id);
    }
	 ...
	 */
	public static final double SERVER_EXP_BONUS_BOOSTED = 2.0;
	/**
	 * XP given when XP is boosted by a voting reward and bonus weekend
	 */
	public static final double SERVER_EXP_BONUS_WEEKEND_BOOSTED = 4.0;
	/**
	...
	public static boolean wildyPursuit = true;

	public static int AMOUNT_OF_SANTA_MINIONS = 1;
	 ...
	 */
	public static final int INCREASE_SPECIAL_AMOUNT = 32000;
	...
	public static final int START_LOCATION_Y = 3498;
